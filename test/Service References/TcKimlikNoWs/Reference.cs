...
namespace test.TcKimlikNoWs {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="TcKimlikNoWs.KPSPublicSoap")]
    public interface KPSPublicSoap {
        ...
        test.TcKimlikNoWs.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(test.TcKimlikNoWs.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest {
        ...
        public test.TcKimlikNoWs.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest() {
        }
        
        public TCKimlikNoDogrulaRequest(test.TcKimlikNoWs.TCKimlikNoDogrulaRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse {
        ...
        public test.TcKimlikNoWs.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse() {
        }
        
        public TCKimlikNoDogrulaResponse(test.TcKimlikNoWs.TCKimlikNoDogrulaResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface KPSPublicSoapChannel : test.TcKimlikNoWs.KPSPublicSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<test.TcKimlikNoWs.KPSPublicSoap>, test.TcKimlikNoWs.KPSPublicSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        test.TcKimlikNoWs.TCKimlikNoDogrulaResponse test.TcKimlikNoWs.KPSPublicSoap.TCKimlikNoDogrula(test.TcKimlikNoWs.TCKimlikNoDogrulaRequest request) {
        ...
        public bool TCKimlikNoDogrula(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            test.TcKimlikNoWs.TCKimlikNoDogrulaRequest inValue = new test.TcKimlikNoWs.TCKimlikNoDogrulaRequest();
            inValue.Body = new test.TcKimlikNoWs.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            test.TcKimlikNoWs.TCKimlikNoDogrulaResponse retVal = ((test.TcKimlikNoWs.KPSPublicSoap)(this)).TCKimlikNoDogrula(inValue);
